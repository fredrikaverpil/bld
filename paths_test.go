...
func TestPaths_In(t *testing.T) {
	fn := Func("test", "test", func(ctx context.Context) error { return nil })
...
func TestPaths_Funcs(t *testing.T) {
	fn := Func("test-func", "test func", func(ctx context.Context) error { return nil })
	p := Paths(fn).In(".")
...
func TestCollectPathMappings(t *testing.T) {
	...
	fn3 := Func("fn3", "func 3", func(ctx context.Context) error { return nil })
...
func TestPaths_Skip(t *testing.T) {
	fn1 := Func("test-format", "format code", func(ctx context.Context) error { return nil })
	fn2 := Func("test-lint", "lint code", func(ctx context.Context) error { return nil })
	fn3 := Func("test-build", "build code", func(ctx context.Context) error { return nil })
